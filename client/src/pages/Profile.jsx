        ...
        <Card sx={{ maxWidth: 345 }}>
          <CardHeader
            action={
              <EditProfileModal
                refetch={refetch}
                profilePicURL={data.me.profilePicURL}
              />
            }
          ...
          <CardContent>
            ...
            <Button variant="none" sx={{ m: 0, p: 0 }} onClick={goToSaved}>
            ...
            <CardContent>
              <Box>
                ...
                {data.me.friends.map((friend, index) => (
                  <>
                    ...
                    >
                      <IconButton onClick={() => confirmAlert(friend._id)}>
                        <PersonRemoveIcon />
                      </IconButton>
              ...
              <Box>
                ...
                {data.me.friendRequests.map((friend, index) => (
                  ...
                  >
                    <IconButton onClick={() => acceptFriendRequest(friend._id)}>
                      <PersonAddIcon />
                    </IconButton>
                    <Avatar src={friend.profilePicURL} sx={{ mr: 1 }} />
                    <Typography>{friend.username}</Typography>
              ...
              <Box>
                ...
                {data.me.friendsYouRequested.map((friend, index) => (
                  ...
                  >
                    <IconButton onClick={() => removeFriendRequest(friend._id)}>
                      <CancelIcon />
                    </IconButton>
                    <Avatar src={friend.profilePicURL} sx={{ mr: 1 }} />
                    <Typography>{friend.username}</Typography>
