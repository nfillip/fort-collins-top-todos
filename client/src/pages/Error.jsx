...
export default function Loading() {
  return (
    ...
    >
      ...
      <Box sx = {{position: "fixed",top:"0px", height:"100%", width: "100%", display: "flex",flexDirection: "column", justifyContent:"center", alignItems:"center"}}>
            
            <Box sx = {{bgcolor: "primary.light", display: "flex", flexDirection:"column", alignItems: "center", justifyContent: "center", p:4, borderRadius:7}}>
        <a href="" target="_blank">
        </a>
        <a href="https://react.dev" target="_blank">
          {/* <img src={loadingIcon} className="logo react" alt="React logo" /> */}
          <img src={collogo} className="logo react" alt="React logo" />
        </a>
        <Typography className = "spinner" color = "white" sx = {{fontSize: "3rem"}}>Server Error...</Typography>
        <Typography className = "spinner" color = "white" sx = {{fontSize: "2rem"}}>Come back later</Typography>
      </Box>
