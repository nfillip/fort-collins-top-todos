  ...
  return (
    <React.Fragment>
      ...
      <div>
        ...
        </DialogActions></>):(<> <div sx={{ justifyContent: 'center' }}>
          <Button variant = "outlined" onClick={() => setLogOrSign("login")}>Login</Button>
          <Button variant = "contained" onClick={() => setLogOrSign("signup")}>Signup</Button>
        </div>
        <Typography sx = {{display: "flex", flexDirection: "row", justifyContent: "center", borderColor: "solid red"}}> 
