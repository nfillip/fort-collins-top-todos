  ...
  return (
    ...
    >
      ...
      <Box sx = {{position: "fixed",top:"0px", height:"100%", width: "100%", display: "flex",flexDirection: "column", justifyContent:"center", alignItems:"center"}}>
            ...
            <Box sx = {{bgcolor: "inherit", display: "flex", flexDirection:"column", alignItems: "center", justifyContent: "center", p:4, borderRadius:7}}>
        ...
        <Typography className = "spinner" color = "white" sx = {{fontSize: "3rem"}}>Loading...</Typography>
      </Box>
