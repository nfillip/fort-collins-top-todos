...
//useMutation
 ...
 const handleEditLocation = async (e) => {
    if(locationName === "" && locationDescription ==="" && locationAddress ==="" && locationCategory.length === 0 && locationImageURL === ""){
   ...
   setTimeout(() => {
    ...
    return (
        <>
        <Button variant = "contained" onClick = {handleClickOpen}>Edit Location</Button>
        ...
        >
          ...
          <IconButton onClick={() => widgetRef.current.open()} sx={{ p: 0 }}>
            {locationImageURL === "" ? <AddPhotoAlternateIcon color = "primary"/>:<Avatar src = {locationImageURL}/> }
          </IconButton>
        </Typography>
        ...
        <DialogContent>
          ...
          Categories
      <FormControlLabel control={<Checkbox />} label="Sunset" value = "sunset"  onChange = {handleLocCategoryChange}/>
      <FormControlLabel control={<Checkbox  />} label="View" value = "view" onChange = {handleLocCategoryChange}/>
      <FormControlLabel control={<Checkbox  />} label="Bar" value = "bar" onChange = {handleLocCategoryChange}/>
      <FormControlLabel control={<Checkbox  />} label="Restaurant" value = "restaurant" onChange = {handleLocCategoryChange}/>
    </FormGroup>
          </div>
        </DialogContent>
        <DialogActions>
        ...
        {({ TransitionProps }) => (
          <Fade {...TransitionProps} timeout={350}>
            <Paper>
              <Typography sx={{ p: 2, color: "red"}}>Fill all fields</Typography>
            </Paper>
          </Fade>
        )}
      </Popper>
